...
<form action="${pageContext.request.contextPath}/auth/update.do" method="post">
	...
	<table>
		...
		<tr>
			<th>BIRTH</th>
			<td><input type="text" name="age" value="${ login_member.birthString }"></td>
		</tr>
		<tr>
			<th>TEL</th>
