...
//				JOptionPane.showMessageDialog(null, msg);
				...
				if(r == JOptionPane.OK_OPTION) {
					...
					if(!chatMap.containsKey(targetIp)) {
						ChatMessage cm = new ChatMessage(np.getTfNickName().getText(), targetIp, targetNickName);
	...
	public void receiveMessage(String sourceIp, String sourceNickName, String msg) {
		...
		if( !chatMap.containsKey(sourceIp) ) {
			ChatMessage cm = new ChatMessage(np.getTfNickName().getText(), sourceIp, sourceNickName);
