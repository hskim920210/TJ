...
public class ClientSocket extends Thread {
	...
	public void send(String targetIp, Object data, String sourceIp, String sourceNickName) {
		Packet packet = new Packet(Packet.TYPE_CLIENT_MSG, data, targetIp, sourceIp, sourceNickName);
		try {
			...
			try {
				...
				switch(packet.getPacketType()) {
					...
					case Packet.TYPE_CLIENT_MSG:
						this.frame.receiveMessage(packet.getSourceIp(), packet.getSourceNickName(), (String)packet.getPacketData());
						break;
				}
